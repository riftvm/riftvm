...
struct VMPreinstalledImageCatalogItem: Identifiable, Hashable {
    ...
    static let omarchy = VMPreinstalledImageCatalogItem(
        ...
        manifestURL: URL(string: "https://github.com/riftvm/riftvm-omarchy-aarch64-image/releases/download/v4.0.3-riftvm.9/riftvm-omarchy-factory-manifest.json")!,
        downloadSize: 5_275_385_856
    )
}
