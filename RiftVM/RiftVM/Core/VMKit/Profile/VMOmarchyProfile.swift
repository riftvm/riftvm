...
/// Versioned product contract shared by RiftVM and the dedicated RiftVM Omarchy app.
...
extension VMOmarchyProfile {
    public static let production = VMOmarchyProfile(
        ...
        factoryImage: .init(
            ...
            manifestURL: URL(string: "https://github.com/riftvm/riftvm-omarchy-aarch64-image/releases/download/v4.0.0-alpha-riftvm.32/riftvm-omarchy-factory-manifest.json")!,
