...
for attempt in first second; do
  ...
  archive="$output/RiftVM-Omarchy-GuestOverlay-0.1.0-test.tar.gz"
...
cmp "$fixture/first/RiftVM-Omarchy-GuestOverlay-0.1.0-test.tar.gz" \
  "$fixture/second/RiftVM-Omarchy-GuestOverlay-0.1.0-test.tar.gz"
