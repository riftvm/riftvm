...
enum OmarchyClipboardAcceptanceProbe {
    ...
    static func run(
        ...
        let hostText = "RiftVM host → Omarchy 文本 \(nonce)"
    ...
    static func probeScript(guestDirectory: String) -> String {
        ...
        copy_until_matches() {
          ...
          output="$2"
          shift 2
          local_part="${XDG_RUNTIME_DIR:-/tmp}/riftvm-clipboard-probe.$$.part"
          local_error="${XDG_RUNTIME_DIR:-/tmp}/riftvm-clipboard-probe.$$.error"
