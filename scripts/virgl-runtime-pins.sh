...
# Original upstream location: https://gitlab.freedesktop.org/virgl/virglrenderer/-/archive/$RIFTVM_VIRGL_UPSTREAM_COMMIT/$RIFTVM_VIRGL_SOURCE_ARCHIVE
readonly RIFTVM_VIRGL_SOURCE_URL=https://github.com/riftvm/riftvm/releases/download/virgl-runtime-inputs-v1/$RIFTVM_VIRGL_SOURCE_ARCHIVE
...
# Original upstream location: https://github.com/google/angle/archive/$RIFTVM_ANGLE_UPSTREAM_COMMIT.tar.gz
readonly RIFTVM_ANGLE_SOURCE_URL=https://github.com/riftvm/riftvm/releases/download/virgl-runtime-inputs-v1/$RIFTVM_ANGLE_SOURCE_ARCHIVE
...
# Original upstream location: https://github.com/anholt/libepoxy/archive/$RIFTVM_EPOXY_UPSTREAM_COMMIT.tar.gz
readonly RIFTVM_EPOXY_SOURCE_URL=https://github.com/riftvm/riftvm/releases/download/virgl-runtime-inputs-v1/$RIFTVM_EPOXY_SOURCE_ARCHIVE
...
# Original upstream location: https://github.com/startergo/homebrew-virglrenderer/archive/$RIFTVM_VIRGL_BUILD_RECIPE_COMMIT.tar.gz
readonly RIFTVM_VIRGL_RECIPE_URL=https://github.com/riftvm/riftvm/releases/download/virgl-runtime-inputs-v1/$RIFTVM_VIRGL_RECIPE_ARCHIVE
...
# Original upstream location: https://github.com/startergo/homebrew-angle/archive/$RIFTVM_ANGLE_BUILD_RECIPE_COMMIT.tar.gz
readonly RIFTVM_ANGLE_RECIPE_URL=https://github.com/riftvm/riftvm/releases/download/virgl-runtime-inputs-v1/$RIFTVM_ANGLE_RECIPE_ARCHIVE
...
# Original upstream location: https://github.com/startergo/homebrew-libepoxy/archive/$RIFTVM_EPOXY_BUILD_RECIPE_COMMIT.tar.gz
readonly RIFTVM_EPOXY_RECIPE_URL=https://github.com/riftvm/riftvm/releases/download/virgl-runtime-inputs-v1/$RIFTVM_EPOXY_RECIPE_ARCHIVE
...
# Original upstream location: https://github.com/startergo/homebrew-virglrenderer/releases/download/v1.0.33/virglrenderer-1.0.33.arm64_sequoia.bottle.tar.gz
readonly RIFTVM_VIRGL_URL=https://github.com/riftvm/riftvm/releases/download/virgl-runtime-inputs-v1/$RIFTVM_VIRGL_ARCHIVE
...
# Original upstream location: https://github.com/startergo/homebrew-angle/releases/download/v1.0.15/angle-1.0.15.arm64_sequoia.bottle.tar.gz
readonly RIFTVM_ANGLE_URL=https://github.com/riftvm/riftvm/releases/download/virgl-runtime-inputs-v1/$RIFTVM_ANGLE_ARCHIVE
...
# Original upstream location: https://github.com/startergo/homebrew-libepoxy/releases/download/v1.0.4/libepoxy-1.0.4.arm64_sequoia.bottle.tar.gz
readonly RIFTVM_EPOXY_URL=https://github.com/riftvm/riftvm/releases/download/virgl-runtime-inputs-v1/$RIFTVM_EPOXY_ARCHIVE
